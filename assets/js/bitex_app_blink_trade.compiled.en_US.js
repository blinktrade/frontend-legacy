...
function $goog$style$setStyle_$$($element$$33$$, $value$$68$$, $prefixedStyle$$inline_135_style$$1$$) {
  ...
  $camelStyle$$inline_134_propertyName$$8$$ && ($element$$33$$.style[$camelStyle$$inline_134_propertyName$$8$$] = $value$$68$$)
}
      ...
      case "select-one":
        ...
        if($goog$isString$$($opt_value$$7$$)) {
          for(var $i$$inline_228_option$$inline_232$$ = 0;$opt_value$$inline_231_option$$inline_227_type$$92$$ = $el$$39$$.options[$i$$inline_228_option$$inline_232$$];$i$$inline_228_option$$inline_232$$++) {
            if($opt_value$$inline_231_option$$inline_227_type$$92$$.value == $opt_value$$7$$) {
        ...
        break;
      case "select-multiple":
        $opt_value$$inline_231_option$$inline_227_type$$92$$ = $opt_value$$7$$;
...
function $JSCompiler_StaticMethods_isSubsetOf$$($JSCompiler_StaticMethods_isSubsetOf$self$$, $col$$17$$) {
  ...
  return $goog$structs$every$$($JSCompiler_StaticMethods_isSubsetOf$self$$, function($JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$) {
    if("function" == typeof $col$$17$$.contains) {
      $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$ = $col$$17$$.contains($JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$)
    }else {
      if("function" == typeof $col$$17$$.$containsValue$) {
        $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$ = $col$$17$$.$containsValue$($JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$)
      }else {
        if($goog$isArrayLike$$($col$$17$$) || $goog$isString$$($col$$17$$)) {
          $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$ = $goog$array$contains$$($col$$17$$, $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$)
        }else {
          a: {
            for(var $key$$inline_1137$$ in $col$$17$$) {
              if($col$$17$$[$key$$inline_1137$$] == $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$) {
                $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$ = $JSCompiler_alias_TRUE$$;
                break a
              }
            }
            $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$ = $JSCompiler_alias_FALSE$$
          }
        }
      }
    }
    return $JSCompiler_temp$$1115_JSCompiler_temp$$1116_JSCompiler_temp$$1117_value$$88$$
  })
}
;
// Input 60
...
function $goog$debug$LogManager$getLogger$$($name$$81$$) {
  ...
  if(!($JSCompiler_temp$$11_logger$$inline_347$$ = $goog$debug$LogManager$loggers_$$[$name$$81$$])) {
    $JSCompiler_temp$$11_logger$$inline_347$$ = new $goog$debug$Logger$$($name$$81$$);
    var $lastDotIndex$$inline_348_parentLogger$$inline_350$$ = $name$$81$$.lastIndexOf("."), $leafName$$inline_349$$ = $name$$81$$.substr($lastDotIndex$$inline_348_parentLogger$$inline_350$$ + 1), $lastDotIndex$$inline_348_parentLogger$$inline_350$$ = $goog$debug$LogManager$getLogger$$($name$$81$$.substr(0, $lastDotIndex$$inline_348_parentLogger$$inline_350$$));
    ...
    $goog$debug$LogManager$loggers_$$[$name$$81$$] = $JSCompiler_temp$$11_logger$$inline_347$$
  }
...
$JSCompiler_prototypeAlias$$.$onOBNewOrder_$ = function $$JSCompiler_prototypeAlias$$$$onOBNewOrder_$$($e$$120_index$$77$$) {
  if(this.$order_book_offer_$ != $JSCompiler_alias_NULL$$) {
    var $msg$$19_side$$5$$ = $e$$120_index$$77$$.data;
    $e$$120_index$$77$$ = $msg$$19_side$$5$$.MDEntryPositionNo - 1;
    var $price$$2$$ = $msg$$19_side$$5$$.MDEntryPx / 1E8, $qty$$1$$ = $msg$$19_side$$5$$.MDEntrySize / 1E8, $username$$3$$ = $msg$$19_side$$5$$.Username, $broker$$3$$ = $msg$$19_side$$5$$.Broker, $orderId$$2$$ = $msg$$19_side$$5$$.OrderID, $msg$$19_side$$5$$ = $msg$$19_side$$5$$.MDEntryType;
    "0" == $msg$$19_side$$5$$ ? $JSCompiler_StaticMethods_insertOrder$$(this.$order_book_bid_$, $e$$120_index$$77$$, $orderId$$2$$, $price$$2$$, $qty$$1$$, $username$$3$$, $broker$$3$$) : "1" == $msg$$19_side$$5$$ && $JSCompiler_StaticMethods_insertOrder$$(this.$order_book_offer_$, $e$$120_index$$77$$, $orderId$$2$$, $price$$2$$, $qty$$1$$, $username$$3$$, $broker$$3$$)
  }
};
...
$JSCompiler_prototypeAlias$$.$setEnabled$ = function $$JSCompiler_prototypeAlias$$$$setEnabled$$($enable$$16$$) {
  ...
  if((!$parent$$inline_695$$ || "function" != typeof $parent$$inline_695$$.isEnabled || $parent$$inline_695$$.isEnabled()) && $JSCompiler_StaticMethods_isTransitionAllowed$$(this, 1, !$enable$$16$$)) {
...
$JSCompiler_prototypeAlias$$.$priceFormatter_$ = function $$JSCompiler_prototypeAlias$$$$priceFormatter_$$($value$$175$$, $rowSet$$14$$) {
  var $priceCurrency$$5$$ = $rowSet$$14$$.Currency;
  return 0 === $value$$175$$ ? "-" : $goog$dom$createDom$$("abbr", {title:this.$app_$.$getCurrencyDescription$($priceCurrency$$5$$)}, this.$app_$.$formatCurrency$($value$$175$$ / 1E8, $priceCurrency$$5$$))
};
...
$JSCompiler_prototypeAlias$$.$amountFormatter_$ = function $$JSCompiler_prototypeAlias$$$$amountFormatter_$$($value$$176$$, $rowSet$$16$$) {
  "D" == $rowSet$$16$$.Operation && ($value$$176$$ *= -1);
  return this.$app_$.$formatCurrency$($value$$176$$ / 1E8, $rowSet$$16$$.Currency)
};
$JSCompiler_prototypeAlias$$.$balanceFormatter_$ = function $$JSCompiler_prototypeAlias$$$$balanceFormatter_$$($value$$177$$, $rowSet$$17$$) {
  return this.$app_$.$formatCurrency$($value$$177$$ / 1E8, $rowSet$$17$$.Currency)
};
...
function $bitex$ui$TradeHistory$$($opt_domHelper$$45$$) {
  ...
  }}, {property:"Price", label:"Price", sortable:$JSCompiler_alias_FALSE$$, formatter:function($value$$178$$) {
    return($value$$178$$ / 1E8).toFixed(8)
  }, classes:function() {
    return $bitex$ui$TradeHistory$CSS_CLASS$$ + "-price"
  }}, {property:"Size", label:"Size", sortable:$JSCompiler_alias_FALSE$$, formatter:function($value$$179$$) {
    return($value$$179$$ / 1E8).toFixed(8)
  }, classes:function() {
...
$JSCompiler_prototypeAlias$$.$onBitexOrderBookNewOrder_$ = function $$JSCompiler_prototypeAlias$$$$onBitexOrderBookNewOrder_$$($e$$207_index$$88$$) {
  var $currency$$12_msg$$74$$ = $e$$207_index$$88$$.data;
  $e$$207_index$$88$$ = $currency$$12_msg$$74$$.MDEntryPositionNo - 1;
  var $price$$9$$ = $currency$$12_msg$$74$$.MDEntryPx / 1E8, $side$$15$$ = $currency$$12_msg$$74$$.MDEntryType, $currency$$12_msg$$74$$ = $currency$$12_msg$$74$$.Symbol.substr(3, 3);
  "0" == $side$$15$$ ? 0 === $e$$207_index$$88$$ && this.$app_$.$model_$.set("formatted_best_bid_" + $currency$$12_msg$$74$$.toLowerCase(), this.$app_$.$formatCurrency$($price$$9$$, $currency$$12_msg$$74$$)) : "1" == $side$$15$$ && 0 === $e$$207_index$$88$$ && this.$app_$.$model_$.set("formatted_best_offer_" + $currency$$12_msg$$74$$.toLowerCase(), this.$app_$.$formatCurrency$($price$$9$$, $currency$$12_msg$$74$$))
};
...
$JSCompiler_prototypeAlias$$.$priceFormatter_$ = function $$JSCompiler_prototypeAlias$$$$priceFormatter_$$($value$$180$$, $rowSet$$18$$) {
  var $priceCurrency$$6$$ = $rowSet$$18$$.Currency;
  return 0 === $value$$180$$ ? "-" : $goog$dom$createDom$$("abbr", {title:this.$app_$.$getCurrencyDescription$($priceCurrency$$6$$)}, this.$app_$.$formatCurrency$($value$$180$$ / 1E8, $priceCurrency$$6$$))
};
$JSCompiler_prototypeAlias$$.$valuePriceFormatter_$ = function $$JSCompiler_prototypeAlias$$$$valuePriceFormatter_$$($value$$181$$, $rowSet$$19$$) {
  var $formatted_paid_value$$1_paid_value$$1$$ = $rowSet$$19$$.PaidValue, $priceCurrency$$7$$ = $rowSet$$19$$.Currency, $currency_description$$3$$ = this.$app_$.$getCurrencyDescription$($priceCurrency$$7$$), $formatted_value$$1$$ = this.$app_$.$formatCurrency$($value$$181$$ / 1E8, $priceCurrency$$7$$);
  return 0 === $value$$181$$ ? 0 === $formatted_paid_value$$1_paid_value$$1$$ ? "-" : $goog$dom$createDom$$("abbr", {title:$currency_description$$3$$}, this.$app_$.$formatCurrency$($formatted_paid_value$$1_paid_value$$1$$ / 1E8, $priceCurrency$$7$$)) : 0 < $formatted_paid_value$$1_paid_value$$1$$ && $formatted_paid_value$$1_paid_value$$1$$ != $value$$181$$ ? ($formatted_paid_value$$1_paid_value$$1$$ = this.$app_$.$formatCurrency$($formatted_paid_value$$1_paid_value$$1$$ / 1E8, $priceCurrency$$7$$), 
...
$JSCompiler_prototypeAlias$$.$onBrokerProcessWithdraw_$ = function $$JSCompiler_prototypeAlias$$$$onBrokerProcessWithdraw_$$($e$$267_handler$$102$$) {
  ...
  var $withdraw_data$$1$$ = $e$$267_handler$$102$$.target.$getWithdrawData$(), $request_id$$1$$ = $e$$267_handler$$102$$.target.$request_id_$, $action$$4$$ = $e$$267_handler$$102$$.target.$withdraw_action_$;
    ...
    if("PROGRESS" === $action$$4$$) {
      ...
      $JSCompiler_StaticMethods_listen$$($e$$267_handler$$102$$, $feeDlg$$, $goog$ui$Dialog$EventType$SELECT$$, function($e$$270$$) {
        if("ok" == $e$$270$$.key) {
          ...
          if($pos$$25$$[0] != $fixed_fee$$2_percent_fee$$2$$.length || isNaN($percent_fee_value$$) || 0 > $percent_fee_value$$) {
            ...
            $pos$$25$$[0] != $fixed_fee$$2_percent_fee$$2$$.length || isNaN($fixed_fee_value$$) || 0 > $fixed_fee_value$$ ? ($e$$270$$.stopPropagation(), $e$$270$$.preventDefault()) : this.$conn_$.$processWithdraw$($request_id$$1$$, $action$$4$$, $withdraw_data$$1$$.WithdrawID, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$, $form_data$$, $percent_fee_value$$, 1E8 * $fixed_fee_value$$)
          }
        }
      })
    }else {
      if("COMPLETE" === $action$$4$$) {
        ...
        $JSCompiler_StaticMethods_listen$$($e$$267_handler$$102$$, $dlg$$3$$, $goog$ui$Dialog$EventType$SELECT$$, function($broker_withdraw_data_e$$271$$) {
          "ok" == $broker_withdraw_data_e$$271$$.key && ($broker_withdraw_data_e$$271$$ = $bitex$util$getFormAsJSON$$($goog$dom$getFirstElementChild$$($dlg$$3$$.$getContentElement$())), this.$conn_$.$processWithdraw$($request_id$$1$$, $action$$4$$, $withdraw_data$$1$$.WithdrawID, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$, $broker_withdraw_data_e$$271$$))
        }, this)
      }
    }
  }
...
$JSCompiler_prototypeAlias$$.$onProcessDeposit_$ = function $$JSCompiler_prototypeAlias$$$$onProcessDeposit_$$($e$$281_handler$$105$$) {
  var $deposit_data$$1$$ = $e$$281_handler$$105$$.target.$getDepositData$(), $request_id$$2$$ = $e$$281_handler$$105$$.target.$request_id_$, $action$$5$$ = $e$$281_handler$$105$$.target.$getDepositAction$();
          ...
          if("ok" == $e$$284$$.key) {
            ...
            if($pos$$27$$[0] != $percent_fee_value$$2_raw_paid_value$$.length || isNaN($paid_value$$2$$) || 0 >= $paid_value$$2$$) {
              ...
              if($pos$$27$$[0] != $fixed_fee$$4_percent_fee$$4$$.length || isNaN($percent_fee_value$$2_raw_paid_value$$) || 0 > $percent_fee_value$$2_raw_paid_value$$) {
                ...
                $pos$$27$$[0] != $fixed_fee$$4_percent_fee$$4$$.length || isNaN($fixed_fee_value$$2$$) || 0 > $fixed_fee_value$$2$$ ? ($e$$284$$.stopPropagation(), $e$$284$$.preventDefault(), $goog$dom$getElement$$($fixed_fee_element_id$$3$$).focus()) : this.$conn_$.$processDeposit$($request_id$$2$$, $action$$5$$, $JSCompiler_alias_VOID$$, $deposit_data$$1$$.DepositID, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$, $paid_value$$2$$, $percent_fee_value$$2_raw_paid_value$$, 1E8 * $fixed_fee_value$$2$$)
              }
            }
          }
        }, this)
...
$JSCompiler_prototypeAlias$$.$onUserLoginOk_$ = function $$JSCompiler_prototypeAlias$$$$onUserLoginOk_$$($e$$301_msg$$100$$) {
  ...
  $e$$301_msg$$100$$.IsBroker || this.$model_$.set("UserBrokers", $user_brokers$$));
  ...
  $goog$isArray$$($broker_currencies$$3_tags$$1_verification_data$$3$$) && $goog$array$forEach$$($broker_currencies$$3_tags$$1_verification_data$$3$$, function($data$$42$$) {
    $goog$isObject$$($data$$42$$) && "name" in $data$$42$$ && ($verification_name$$ = $data$$42$$.name)
  });
  ...
  if($zopim != $JSCompiler_alias_NULL$$) {
...
$JSCompiler_prototypeAlias$$.$onUserLoginError_$ = function $$JSCompiler_prototypeAlias$$$$onUserLoginError_$$($e$$303_msg$$101$$) {
  ...
  $e$$303_msg$$101$$ = $e$$303_msg$$101$$.data;
  this.$model_$.set("UserID", "");
  this.$model_$.set("Username", "");
  if($e$$303_msg$$101$$.NeedSecondFactor) {
    ...
    $JSCompiler_StaticMethods_listen$$(this.$getHandler$(), $dlg_$$1$$, $goog$ui$Dialog$EventType$SELECT$$, function($e$$304_second_factor$$1$$) {
      if("ok" == $e$$304_second_factor$$1$$.key) {
        ...
        }, this), $e$$304_second_factor$$1$$.stopPropagation(), $e$$304_second_factor$$1$$.preventDefault()) : ($e$$304_second_factor$$1$$ = $JSCompiler_StaticMethods_getAsJSON$$($gauth_uniform$$1$$).token, this.$conn_$.login(this.$loginView_$.$getUsername$(), this.$loginView_$.$getPassword$(), $e$$304_second_factor$$1$$), $dlg_$$1$$.$dispose$())
      }
    })
  }else {
    var $user_status_text$$ = $e$$303_msg$$101$$.UserStatusText;
    switch($e$$303_msg$$101$$.UserStatusText) {
...
$JSCompiler_prototypeAlias$$.$onUserSignupButton_$ = function $$JSCompiler_prototypeAlias$$$$onUserSignupButton_$$($e$$305$$) {
  this.$model_$.set("Password", $e$$305$$.target.$getPassword$());
  this.$conn_$.$signUp$($e$$305$$.target.$getUsername$(), $e$$305$$.target.$getPassword$(), $e$$305$$.target.$getEmail$(), $e$$305$$.target.$getState$(), $goog$dom$forms$getValue$$($goog$dom$getElement$$("id_signup_country")), $goog$string$toNumber$$($goog$dom$forms$getValue$$($goog$dom$getElement$$("id_signup_broker"))))
};
$JSCompiler_prototypeAlias$$.$getModel$ = $JSCompiler_get$$("$model_$");
$JSCompiler_prototypeAlias$$.$onBeforeSetView_$ = function $$JSCompiler_prototypeAlias$$$$onBeforeSetView_$$($classes$$11_e$$306_view$$4$$) {
  var $view_id$$5$$ = $classes$$11_e$$306_view$$4$$.$view_id$;
  $classes$$11_e$$306_view$$4$$ = $classes$$11_e$$306_view$$4$$.view;
  $classes$$11_e$$306_view$$4$$.$inDocument_$ || (console.log("Creating view:" + $view_id$$5$$), $classes$$11_e$$306_view$$4$$.$decorate$($goog$dom$getElement$$($view_id$$5$$)));
  ...
  $classes$$11_e$$306_view$$4$$ = $goog$dom$classes$get$$(document.body);
  var $classes_to_remove$$ = [];
  $goog$array$forEach$$($classes$$11_e$$306_view$$4$$, function($cls$$2$$) {
...
$JSCompiler_prototypeAlias$$.$getBrokersByCountry$ = function $$JSCompiler_prototypeAlias$$$$getBrokersByCountry$$($country$$1$$, $opt_state$$2$$) {
  ...
  $opt_state$$2$$ != $JSCompiler_alias_NULL$$ && ($query$$3$$ += "_" + $opt_state$$2$$);
...
$JSCompiler_prototypeAlias$$.$onSecurityList_$ = function $$JSCompiler_prototypeAlias$$$$onSecurityList_$$($e$$307_msg$$102$$) {
  $e$$307_msg$$102$$ = $e$$307_msg$$102$$.data;
  $goog$array$forEach$$($e$$307_msg$$102$$.Currencies, function($currency$$23$$) {
  ...
  var $symbols$$3$$ = [];
  $goog$array$forEach$$($e$$307_msg$$102$$.Instruments, function($instrument$$2$$) {
  ...
  this.$model_$.set("SecurityList", $e$$307_msg$$102$$)
};
...
$JSCompiler_prototypeAlias$$.$onBrokerListResponse_$ = function $$JSCompiler_prototypeAlias$$$$onBrokerListResponse_$$($current_view_e$$308$$) {
  var $msg$$103$$ = $current_view_e$$308$$.data, $broker_list$$3$$ = [];
  $goog$array$forEach$$($msg$$103$$.BrokerListGrp, function($broker_array$$) {
    var $broker_info$$9$$ = {};
    $goog$array$forEach$$($msg$$103$$.Columns, function($column$$4$$, $index$$89$$) {
      $broker_info$$9$$[$column$$4$$] = $broker_array$$[$index$$89$$]
    }, this);
  ...
  ($current_view_e$$308$$ = location.pathname.replace("/", "")) && "-1" == $current_view_e$$308$$.indexOf(".html") && this.$router_$.$setView$($current_view_e$$308$$)
};
...
$JSCompiler_prototypeAlias$$.$onHearbeat_$ = function $$JSCompiler_prototypeAlias$$$$onHearbeat_$$($e$$313_msg$$104$$) {
  $e$$313_msg$$104$$ = $e$$313_msg$$104$$.data;
  ...
  $e$$313_msg$$104$$.SendTime != $JSCompiler_alias_NULL$$ && this.$model_$.set("latency", new Date(Date.now()) - new Date($e$$313_msg$$104$$.SendTime))
};
...
$JSCompiler_prototypeAlias$$.$onConnectionErrorMessage_$ = function $$JSCompiler_prototypeAlias$$$$onConnectionErrorMessage_$$($e$$316_msg$$105$$) {
  $e$$316_msg$$105$$ = $e$$316_msg$$105$$.data;
  this.$showNotification$("error", "Message from server:", $e$$316_msg$$105$$.Description + " - " + $e$$316_msg$$105$$.Detail, this.$error_message_alert_timeout_$)
};
