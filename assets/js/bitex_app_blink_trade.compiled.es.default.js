    ...
    if(!$opt_data$$10$$.$msg_broker$.IsBrokerHub) {
      ...
      for($allowed_marketIndex126_crypto_currenciesIndex202_feeIndex171_key$$inline_502$$ = 0;$allowed_marketIndex126_crypto_currenciesIndex202_feeIndex171_key$$inline_502$$ < $allowed_marketListLen126_crypto_currenciesListLen202_feeListLen171_map$$inline_500$$;$allowed_marketIndex126_crypto_currenciesIndex202_feeIndex171_key$$inline_502$$++) {
        for(var $crypto_currenciesData202_feeData171$$ = $crypto_currenciesList202_feeList171_mapKeys$$inline_501$$[$allowed_marketIndex126_crypto_currenciesIndex202_feeIndex171_key$$inline_502$$], $walletsList203$$ = $crypto_currenciesData202_feeData171$$.Wallets, $walletsListLen203$$ = $walletsList203$$.length, $walletsIndex203$$ = 0;$walletsIndex203$$ < $walletsListLen203$$;$walletsIndex203$$++) {
          ...
          $output$$8$$ += "</td><td>";
          $output$$8$$ = $walletsData203$$.multisig ? $output$$8$$ + "Si" : $output$$8$$ + "No";
...
function $bitex$templates$YourAccountSummary$$($opt_data$$16$$) {
  ...
  for(var $accountList356$$ = $opt_data$$16$$.$accounts$, $accountListLen356$$ = $accountList356$$.length, $accountIndex356$$ = 0;$accountIndex356$$ < $accountListLen356$$;$accountIndex356$$++) {
    ...
    for(var $currency_infoList368$$ = $accountData356$$.currencies, $currency_infoListLen368$$ = $currency_infoList368$$.length, $currency_infoIndex368$$ = 0;$currency_infoIndex368$$ < $currency_infoListLen368$$;$currency_infoIndex368$$++) {
      ...
      '" data-blink-class="balance-info-blink">' + $soy$$0$0escapeHtml$$($currency_infoData368$$.formattedBalance) + '</span><abbr title="Dep\u00f3sitos no confirmados de sus cuentas confirmadas"><em><span class="bitex-model" data-model-key="formatted_position_' + $soy$$0$0escapeHtml$$($accountData356$$.brokerID) + ":" + $soy$$0$0escapeHtml$$($accountData356$$.clientID) + "_" + $soy$$0$0escapeHtml$$($currency_infoData368$$.currency) + '" data-blink-class="balance-info-blink"></span></em></abbr></td><td style="padding: 4px;border-left:0;' + 
...
function $bitex$templates$ConfirmDepositCryptoCurrencyContentDialog$$($MSG_UNNAMED_1605_opt_data$$22$$) {
  var $output$$19$$ = "";
  $MSG_UNNAMED_1605_opt_data$$22$$ = "Se le crear\u00e1 una direcci\u00f3n " + ($soy$$0$0escapeHtml$$($MSG_UNNAMED_1605_opt_data$$22$$.$currencydescription$) + " \u00fanica que sera v\u00e1lida s\u00f3lo para esta transacci\u00f3n.");
  return $output$$19$$ + ('<div class="row-fluid" data-deposit-status="confirm"><h3 class="text-center">IMPORTANTE!</h3><h4 class="text-center">' + $MSG_UNNAMED_1605_opt_data$$22$$ + '</h4><h3 class="text-center">Lo ha entendido?</h3><br/><br/></div>')
}
...
function $bitex$templates$YourAccountBalances$$($currencyList946_opt_data$$28$$) {
  ...
  for(var $currencyListLen946$$ = $currencyList946_opt_data$$28$$.length, $currencyIndex946$$ = 0;$currencyIndex946$$ < $currencyListLen946$$;$currencyIndex946$$++) {
    var $currencyData946$$ = $currencyList946_opt_data$$28$$[$currencyIndex946$$], $MSG_UNNAMED_1655$$ = "Disponible " + $soy$$0$0escapeHtml$$($currencyData946$$.code), $output$$24$$ = $output$$24$$ + ("<tr><td><strong>" + $MSG_UNNAMED_1655$$ + '</strong></td><td><span class="bitex-model" data-model-key="formatted_balance_' + $soy$$0$0escapeHtml$$($currencyData946$$.$model_key$) + '" data-blink-class="balance-info-blink">' + ($currencyData946$$.$balance$ ? $soy$$0$0escapeHtml$$($currencyData946$$.$balance$) : 
    "-") + "</span></td></tr>")
  }
...
function $bitex$ui$AdvancedOrderEntry$templates$AdvancedOrderEntry$$($opt_data$$37$$) {
  ...
  $soy$$0$0escapeHtml$$($opt_data$$37$$.id) + '_amount_sign" class="add-on advanced-order-entry-amount-sign">' + $soy$$0$0escapeHtml$$($opt_data$$37$$.$amount_currency_symbol$) + '</span><input id="' + $soy$$0$0escapeHtml$$($opt_data$$37$$.id) + '_amount" name="amount" type="text" class="input-block-level" data-uniform-label="Amount" data-uniform-validators="validateNumber; required" value="" required/></div></div></div><div class="row-fluid uniform-control-holder"><div class="span5"> <span>Precio por:<span class="advanced-order-entry-amount-sign">' + 
...
function $bitex$ui$withdraw_methods$templates$WithdrawMethods$$($currList62_opt_data$$38$$) {
  var $output$$34$$;
  $output$$34$$ = "" + ('<div class="row-fluid"><div class="span12"><table id="' + $soy$$0$0escapeHtml$$($currList62_opt_data$$38$$.id) + '_table" class="table table-condensed table-hover"><thead><tr><th> Moneda</th><th> Nombre</th><th> T\u00e9rminos </th><th> Comisi\u00f3n</th><th> Acciones </th></tr></thead><tbody>');
  ...
  return $output$$34$$ + '</ul></div><div class="withdraw-methods-show-when-saving-state span4 pull-right" ><div class="progress progress-success progress-striped active"><div class="bar" style="width: 100%">Guardando...</div></div></div><div class="clearfix"></div></div></div>'
}
;
// Input 123
  ...
  for($fieldList185_level214$$ = 0;6 > $fieldList185_level214$$;$fieldList185_level214$$++) {
    ...
    switch($fieldList185_level214$$) {
      ...
      case 2:
        ...
        break;
      case 3:
        $output$$36$$ += "<td>Verificado - Nivel I</td>";
        break;
      case 4:
        $output$$36$$ += "<td>Verificado - Nivel II</td>";
        break;
      case 5:
        $output$$36$$ += "<td>Verificado - Nivel III</td>"
    }
...
function $bitex$ui$ChangePassword$templates$ChangePassword$$($opt_data$$41_output$$37$$) {
  return $opt_data$$41_output$$37$$ = "" + ('<div class="section-title"><h3 class="bitex-view-title">Cambie su contrase\u00f1a </h3></div><div id="' + $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '"><div class="clearfix"><label for="' + $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_oldpassword">Contrase\u00f1a actual</label><div class="input"><input autocapitalize="off" autocorrect="off" id="' + $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_oldpassword" name="username" type="password" ></div></div><div class="clearfix"><label for="' + 
  $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_password">Nueva contrase\u00f1a</label><div class="input"><input id="' + $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_password" placeholder="" name="password" type="password"></div></div><div class="clearfix"><label for="' + $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_repeat_password">Comfirme nueva contrase\u00f1a</label><div class="input"><input id="' + $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_repeat_password" placeholder="" name="repeat_password" type="password"></div></div><div class="actions"><button id="' + 
  $soy$$0$0escapeHtml$$($opt_data$$41_output$$37$$.id) + '_change" class="btn btn-primary">Cambie contrase\u00f1a</button></div></div>')
}
;
// Input 127
...
function $bitex$ui$market_view_table$templates$MarketViewTable$$($instList30_opt_data$$45$$) {
  var $output$$39$$;
  $output$$39$$ = "" + ('<div class="row-fluid"><div class="span12"><table id="' + $soy$$0$0escapeHtml$$($instList30_opt_data$$45$$.id) + '_table" class="table table-bordered table-condensed"><thead><tr><th> Pareja</th><th> \u00daltimo </th><th> Bid </th><th> Ask </th><th> Volumen (BTC) </th><th> Volumen </th><th> Alto </th><th> Bajo </th></tr></thead><tbody>');
