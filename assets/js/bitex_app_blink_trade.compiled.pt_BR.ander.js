...
function $bitex$templates$BrokerView$$($opt_data$$10$$) {
  var $output$$8$$ = "";
  $opt_data$$10$$.$show_title$ && ($output$$8$$ += '<header class="page__head section-title"><h1 class="page__title beta">Meu corretor</h1></header>');
  ...
  if(-1 != $opt_data$$10$$.$msg_broker$.BrokerID) {
    ...
    if(0 <= $opt_data$$10$$.$msg_broker$.BrokerID && 0 < $opt_data$$10$$.$msg_broker$.FeeStructure.length) {
      $output$$8$$ += '\x3c!-- .broker-fee --\x3e<div class="broker-fee"><h4 class="broker-fee__title">Taxas</h4><table class="broker-fee__table table"><thead><tr><th>Opera\u00e7\u00e3o</th><th>Taxa</th><th>Termos</th></tr></thead><tbody>';
    ...
    if(!$opt_data$$10$$.$msg_broker$.IsBrokerHub) {
      $output$$8$$ += '\x3c!-- .broker-wallet --\x3e<div class="broker-wallet"><h4 class="broker-wallet__title">Carteiras</h4><table class="broker-wallet__table table"><thead><tr><th>Moeda</th><th>Tipo</th><th>Endere\u00e7o</th><th>Multi-assinatura</th><th>Ger\u00eanciada por</th></tr></thead><tbody>';
    ...
    $output$$8$$ += '\x3c!-- .broker-terms --\x3e<div class="broker-terms"><h4 class="broker-terms__title">Termos de servi\u00e7o</h4><iframe class="broker-terms__iframe" src="' + $soy$$0$0escapeHtml$$($opt_data$$10$$.$msg_broker$.TosUrl) + '"></iframe></div>\x3c!-- /.broker-terms --\x3e'
  }
  return $output$$8$$ + "</div>"
}
...
function $bitex$templates$YourAccountSummary$$($opt_data$$16$$) {
  var $output$$14$$;
  $output$$14$$ = '<div class="sidebar-box__head"><h6>Sua conta:</h6></div><div class="sidebar-box__body">';
...
function $bitex$templates$ConfirmDepositCryptoCurrencyContentDialog$$($MSG_UNNAMED_1536_opt_data$$22$$) {
  var $output$$19$$ = "";
  $MSG_UNNAMED_1536_opt_data$$22$$ = "Ser\u00e1 criado um endere\u00e7o de " + ($soy$$0$0escapeHtml$$($MSG_UNNAMED_1536_opt_data$$22$$.$currencydescription$) + " \u00fanico e exclusivo que ser\u00e1 v\u00e1lido somente para este dep\u00f3sito.");
  return $output$$19$$ + ('<div data-deposit-status="confirm"><h5 style="margin-bottom:0;"> IMPORTANTE! <br /><br /><div style="font-weight:400;">' + $MSG_UNNAMED_1536_opt_data$$22$$ + "</div><br /> Voc\u00ea entendeu? </h5></div>")
}
  ...
  for($methodIndex588_methodIndex613_methodIndex667$$ = 0;$methodIndex588_methodIndex613_methodIndex667$$ < $methodListLen588_methodListLen613_methodListLen667$$;$methodIndex588_methodIndex613_methodIndex667$$++) {
    if($fieldList883_methodData588_methodData613_methodData667$$ = $methodList588_methodList613_methodList667$$[$methodIndex588_methodIndex613_methodIndex667$$], $opt_data$$26$$.$force_method$) {
      if($fieldList883_methodData588_methodData613_methodData667$$.method == $opt_data$$26$$.$force_method$) {
        ...
        '"><input id="' + $soy$$0$0escapeHtml$$($fieldList883_methodData588_methodData613_methodData667$$.method) + "_" + $soy$$0$0escapeHtml$$($opt_data$$26$$.$fixedFeeID$) + '" type="hidden" value="' + $soy$$0$0escapeHtml$$($fieldList883_methodData588_methodData613_methodData667$$.fixed_fee) + '"><label class="modal-form__label">Taxas:</label><label id="' + $soy$$0$0escapeHtml$$($fieldList883_methodData588_methodData613_methodData667$$.method) + "_" + $soy$$0$0escapeHtml$$($opt_data$$26$$.$totalFeesID$) + 
        '" class="control-label" style="text-align: left;"></label><div ' + ($opt_data$$26$$.$hideNetAmount$ ? ' style="display:none;"' : "") + '><label class="modal-form__label">Valor l\u00edquido:</label><label id="' + $soy$$0$0escapeHtml$$($fieldList883_methodData588_methodData613_methodData667$$.method) + "_" + $soy$$0$0escapeHtml$$($opt_data$$26$$.$netValueID$) + '" class="control-label" style="text-align: left;"></label><input id="' + $soy$$0$0escapeHtml$$($fieldList883_methodData588_methodData613_methodData667$$.method) + 
...
function $bitex$templates$YourAccountBalances$$($currencyList931_opt_data$$28$$) {
  ...
  for(var $currencyListLen931$$ = $currencyList931_opt_data$$28$$.length, $currencyIndex931$$ = 0;$currencyIndex931$$ < $currencyListLen931$$;$currencyIndex931$$++) {
    var $currencyData931$$ = $currencyList931_opt_data$$28$$[$currencyIndex931$$], $MSG_UNNAMED_1586$$ = $soy$$0$0escapeHtml$$($currencyData931$$.code) + " dispon\u00edveis", $output$$24$$ = $output$$24$$ + ("<tr><td><strong>" + $MSG_UNNAMED_1586$$ + '</strong></td><td><span class="bitex-model" data-model-key="formatted_balance_' + $soy$$0$0escapeHtml$$($currencyData931$$.$model_key$) + '" data-blink-class="balance-info-blink">' + ($currencyData931$$.$balance$ ? $soy$$0$0escapeHtml$$($currencyData931$$.$balance$) : 
    "-") + "</span></td></tr>")
  }
...
function $bitex$templates$AccountOverviewUser$$($opt_data$$33$$) {
  var $output$$29$$;
  $output$$29$$ = "" + ('<table class="profile-table table"><tbody><tr><td><strong>ID</strong></td><td>' + $soy$$0$0escapeHtml$$($opt_data$$33$$.$msg_customer_detail$.ID) + "</td></tr><tr><td><strong>Username</strong></td><td>" + $soy$$0$0escapeHtml$$($opt_data$$33$$.$msg_customer_detail$.Username) + "</td></tr><tr><td><strong>Email</strong></td><td>" + $soy$$0$0escapeHtml$$($opt_data$$33$$.$msg_customer_detail$.Email) + "</td></tr><tr><td><strong>Estado</strong></td><td>" + $soy$$0$0escapeHtml$$($opt_data$$33$$.$msg_customer_detail$.State) + 
  "</td></tr><tr><td><strong>Pa\u00eds</strong></td><td>" + $soy$$0$0escapeHtml$$($opt_data$$33$$.$msg_customer_detail$.CountryCode) + '</td></tr><tr><td><strong>\u00c9 verificado</strong></td><td class="account-overview-val account-overview-verified">');
...
function $bitex$ui$AdvancedOrderEntry$templates$AdvancedOrderEntry$$($opt_data$$36$$) {
  ...
  $output$$32$$ += ' BTC</header>\x3c!-- /.box__head --\x3e\x3c!-- .box__body --\x3e<div class="box__body">\x3c!-- .table --\x3e<table class="table table--bordered table--bid-ask"><tbody><tr class="uniform-control-holder"><th class="one-half lap--four-tenths"><label for="" class="order-entry-label"><span>Quantidade: ' + $soy$$0$0escapeHtml$$($opt_data$$36$$.$amount_currency_symbol$) + '</label></th><td class="one-half lap--six-tenths order-entry-data"><input id="' + $soy$$0$0escapeHtml$$($opt_data$$36$$.id) + 
  ...
  $soy$$0$0escapeHtml$$($opt_data$$36$$.id) + '_client_id" name="client_id" type="text" value="' + ($opt_data$$36$$.$client_id$ ? $soy$$0$0escapeHtml$$($opt_data$$36$$.$client_id$) : "") + '" class="input input--full" label="C\u00f3d. do Cliente" data-uniform-label="C\u00f3d. do Cliente"' + ($opt_data$$36$$.$is_broker$ ? 'data-uniform-validators="required"' : 'style="display:none" disabled') + '/></div>\x3c!-- /.layout__item --\x3e\x3c!-- .layout__item --\x3e<div class="layout__item four-tenths"><button id="' + 
...
function $bitex$ui$withdraw_methods$templates$WithdrawMethods$$($currList62_opt_data$$37$$) {
  var $output$$33$$;
  $output$$33$$ = "" + ('<table id="' + $soy$$0$0escapeHtml$$($currList62_opt_data$$37$$.id) + '_table" class="profile-table table"><thead><tr><th> Currency</th><th> Name</th><th> Disclaimer </th><th> Taxas</th><th> Actions </th></tr></thead><tbody>');
...
$JSCompiler_prototypeAlias$$.$onChangePasswordResponse_$ = function $$JSCompiler_prototypeAlias$$$$onChangePasswordResponse_$$($e$$248_msg$$86$$) {
  ...
  if($e$$248_msg$$86$$.NeedSecondFactor) {
    ...
    "MSG_SUCCESS_PASSWORD_CHANGE" == $e$$248_msg$$86$$.UserStatusText ? this.$showDialog$("Password changed!", "Sucesso") : this.$showDialog$($e$$248_msg$$86$$.UserStatusText)
  }
};
...
$JSCompiler_prototypeAlias$$.$onBitexPasswordChangedOk_$ = function $$JSCompiler_prototypeAlias$$$$onBitexPasswordChangedOk_$$($e$$252_msg$$88$$) {
  ...
  "MSG_SUCCESS_PASSWORD_CHANGE" == $e$$252_msg$$88$$.UserStatusText ? this.$showDialog$("Password changed!", "Sucesso") : this.$showDialog$($e$$252_msg$$88$$.UserStatusText, "Sucesso");
...
$JSCompiler_prototypeAlias$$.$onBitexWithdrawIncrementalUpdate_$ = function $$JSCompiler_prototypeAlias$$$$onBitexWithdrawIncrementalUpdate_$$($e$$254_msg$$90$$) {
  ...
  var $MSG_WITHDRAW_NOTIFICATION_USER_UNCONFIRMED_TITLE$$ = "Criado solicita\u00e7\u00e3o de saque [" + ($e$$254_msg$$90$$.WithdrawID + "]"), $MSG_WITHDRAW_NOTIFICATION_USER_CONFIRMED_TITLE$$ = "Pedido de saque [" + ($e$$254_msg$$90$$.WithdrawID + "] confirmado"), $MSG_WITHDRAW_NOTIFICATION_USER_PROGRESS_TITLE$$ = "Pedido de saque [" + ($e$$254_msg$$90$$.WithdrawID + "] em andamento"), $MSG_WITHDRAW_NOTIFICATION_USER_COMPLETE_TITLE$$ = "Pedido de saque [" + ($e$$254_msg$$90$$.WithdrawID + "] completo"), 
  $MSG_WITHDRAW_NOTIFICATION_USER_CANCEL_TITLE$$ = "Pedido de saque [" + ($e$$254_msg$$90$$.WithdrawID + "] cancelado"), $formatted_value$$2$$ = this.$formatCurrency$($e$$254_msg$$90$$.Amount / 1E8, $e$$254_msg$$90$$.Currency), $notification_type_title$$;
...
$JSCompiler_prototypeAlias$$.$onBitexExecutionReport_$ = function $$JSCompiler_prototypeAlias$$$$onBitexExecutionReport_$$($e$$256_msg$$92$$) {
  ...
  var $MSG_ORDER_EXECUTION_TITLE_NOTIFICATION$$ = "Ordem " + $e$$256_msg$$92$$.OrderID;
...
$JSCompiler_prototypeAlias$$.$onConnectionErrorMessage_$ = function $$JSCompiler_prototypeAlias$$$$onConnectionErrorMessage_$$($e$$317_msg$$106$$) {
  ...
  this.$showNotification$("error", "Mensagem do servidor:", $e$$317_msg$$106$$.Description + " - " + $e$$317_msg$$106$$.Detail, this.$error_message_alert_timeout_$)
};
