...
#   > ../assets/js/bitex.compiled.pt_BR.js
#
...
#   > ../assets/js/bitex_app_blink_trade.compiled.es.js
...
#  --compiler_flags="--formatting=PRETTY_PRINT" \
#  --compiler_flags="--formatting=PRINT_INPUT_DELIMITER" \
#   > ../assets/js/bitex_app_blink_trade.compiled.pt_BR.js



## BlinkTrade Merchant Application - enUS
#python ./closure-library/closure/bin/build/closurebuilder.py  \
#  --root=./closure-library/ \
#  --root=./closure-bootstrap/javascript/ \
#  --root=./scottlogic/ \
