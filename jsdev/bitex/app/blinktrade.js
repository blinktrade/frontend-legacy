  ...
  handler.listen(dlg, goog.ui.Dialog.EventType.SELECT, function(e) {
    if (e.key == 'yes') {
      ...
      var algo_sandbox = [
        ...
        '\n',
        '\n',
        'var f,k=this;function n(a){return void 0!==a}\n',
        'function p(a){var b=typeof a;if("object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;var c=Object.prototype.toString.call(a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";\n',
        'else if("function"==b&&"undefined"==typeof a.call)return"object";return b}function q(a){return"array"==p(a)}function r(a){var b=p(a);return"array"==b||"object"==b&&"number"==typeof a.length}function t(a){return"string"==typeof a}function u(a){var b=typeof a;return"object"==b&&null!=a||"function"==b}var v="closure_uid_"+(1E9*Math.random()>>>0),aa=0;function w(a){var b=p(a);if("object"==b||"array"==b){if(a.clone)return a.clone();var b="array"==b?[]:{},c;for(c in a)b[c]=w(a[c]);return b}return a}\n',
        ...
        'function z(a,b){var c=Array.prototype.slice.call(arguments,1);return function(){var b=c.slice();b.push.apply(b,arguments);return a.apply(this,b)}}var da=Date.now||function(){return+new Date},A=null;function B(a,b){var c=a.split("."),d=k;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)!c.length&&n(b)?d[e]=b:d=d[e]?d[e]:d[e]={}}function C(a,b){D.prototype[a]=b};var E=Array.prototype,F=E.indexOf?function(a,b,c){return E.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(t(a))return t(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},ea=E.lastIndexOf?function(a,b,c){return E.lastIndexOf.call(a,b,null==c?a.length-1:c)}:function(a,b,c){c=null==c?a.length-1:c;0>c&&(c=Math.max(0,a.length+c));if(t(a))return t(b)&&1==b.length?a.lastIndexOf(b,c):-1;for(;0<=c;c--)if(c in a&&a[c]===b)return c;\n',
        'return-1},G=E.forEach?function(a,b,c){E.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=t(a)?a.split(""):a,g=0;g<d;g++)g in e&&b.call(c,e[g],g,a)};function H(a,b,c){for(var d=t(a)?a.split(""):a,e=a.length-1;0<=e;--e)e in d&&b.call(c,d[e],e,a)}\n',
        'var fa=E.filter?function(a,b,c){return E.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=[],g=0,h=t(a)?a.split(""):a,l=0;l<d;l++)if(l in h){var m=h[l];b.call(c,m,l,a)&&(e[g++]=m)}return e},ga=E.map?function(a,b,c){return E.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),g=t(a)?a.split(""):a,h=0;h<d;h++)h in g&&(e[h]=b.call(c,g[h],h,a));return e},ha=E.reduce?function(a,b,c,d){d&&(b=x(b,d));return E.reduce.call(a,b,c)}:function(a,b,c,d){var e=c;G(a,function(c,h){e=b.call(d,e,\n',
        'c,h,a)});return e},ia=E.reduceRight?function(a,b,c,d){d&&(b=x(b,d));return E.reduceRight.call(a,b,c)}:function(a,b,c,d){var e=c;H(a,function(c,h){e=b.call(d,e,c,h,a)});return e},ja=E.some?function(a,b,c){return E.some.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=t(a)?a.split(""):a,g=0;g<d;g++)if(g in e&&b.call(c,e[g],g,a))return!0;return!1},ka=E.every?function(a,b,c){return E.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=t(a)?a.split(""):a,g=0;g<d;g++)if(g in e&&!b.call(c,e[g],g,a))return!1;\n',
        'return!0};function I(a,b,c){for(var d=a.length,e=t(a)?a.split(""):a,g=0;g<d;g++)if(g in e&&b.call(c,e[g],g,a))return g;return-1}function J(a,b,c){for(var d=t(a)?a.split(""):a,e=a.length-1;0<=e;e--)if(e in d&&b.call(c,d[e],e,a))return e;return-1}function K(a,b){return 0<=F(a,b)}function L(a,b,c){M(a,c,0,b)}function N(a,b){return 1==E.splice.call(a,b,1).length}function O(a){var b=a.length;if(0<b){for(var c=Array(b),d=0;d<b;d++)c[d]=a[d];return c}return[]}\n',
        'function M(a,b,c,d){return E.splice.apply(a,P(arguments,1))}function P(a,b,c){return 2>=arguments.length?E.slice.call(a,b):E.slice.call(a,b,c)}function Q(a,b,c){return R(a,c||S,!1,b)}function R(a,b,c,d,e){for(var g=0,h=a.length,l;g<h;){var m=g+h>>1,y;y=c?b.call(e,a[m],m,a):b(d,a[m]);0<y?g=m+1:(h=m,l=!y)}return l?g:~g}function T(a,b){a.sort(b||S)}function la(a,b,c){var d=c||S;T(a,function(a,c){return d(b(a),b(c))})}function S(a,b){return a>b?1:a<b?-1:0}function U(a,b){return a===b}\n',
        'function V(a){for(var b=[],c=0;c<arguments.length;c++){var d=arguments[c];if(q(d))for(var e=0;e<d.length;e+=8192)for(var g=V.apply(null,P(d,e,e+8192)),h=0;h<g.length;h++)b.push(g[h]);else b.push(d)}return b};function W(a,b,c){for(var d in a)b.call(c,a[d],d,a)}function ma(a,b){for(var c in a)if(a[c]==b)return!0;return!1}function X(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return d}function Y(a,b){var c;(c=b in a)&&delete a[b];return c}function na(a){var b=p(a);if("object"==b||"array"==b){if(a.clone)return a.clone();var b="array"==b?[]:{},c;for(c in a)b[c]=na(a[c]);return b}return a}var oa="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");\n',
        ...
        'f.n=function(){postMessage({rep:"cancel_order",instance:this.a})};f.t=function(){return this.c[this.j]};f.p=function(a,b){return"deposit"==b?this.e[a]:"available"==b?null!=this.e[a+"_locked"]?this.e[a]-this.e[a+"_locked"]:null!=this.e[a]?this.e[a]:0:null!=b?this.e[a+"_"+b]:this.e[a]};f.v=function(){return this.m};f.u=function(){return this.i};f.s=function(){return this.f};f.r=function(){return this.j};f.q=function(){return this.a};\n',
        ...
        'f.B=function(){postMessage({rep:"create",instance:this.a,status:"ws_open"});var a=[this.j];this.g.send(JSON.stringify({MsgType:"V",MDReqID:parseInt(1E7*Math.random(),10),SubscriptionRequestType:"1",MarketDepth:0,MDUpdateType:"1",MDEntryTypes:["0","1","2"],Instruments:a}));this.g.send(JSON.stringify({MsgType:"e",SecurityStatusReqID:parseInt(1E7*Math.random(),10),SubscriptionRequestType:"1",Instruments:a}));setTimeout(x(this.F,this),3E4)};\n',
        'f.F=function(){this.g.send(JSON.stringify({MsgType:"1",TestReqID:parseInt(1E7*Math.random(),10),SendTime:(new Date).getTime()}))};function sa(a){var b=Z;if(!b.d){try{b.i=a,b.b.start(a),b.d=!0}catch(c){}postMessage({rep:"start",instance:b.a})}}function ta(a,b){try{a.d&&(a.b.stop(),a.d=!1)}catch(c){}null==b?postMessage({rep:"terminate",instance:a.a}):postMessage({rep:"terminate",instance:a.a,error:b})}\n',
        'function ua(a){var b=Z;pa(b.e,a);try{W(a,function(a,b){if("locked"==b.substring(4))this.b.onBalanceUpdate(b.substring(0,3),a,AlgorithmTradingInterface.BalanceType.LOCKED);else this.b.onBalanceUpdate(b,a,AlgorithmTradingInterface.BalanceType.DEPOSIT)},b)}catch(c){}postMessage({rep:"balance",instance:b.a})}function va(a){var b=Z;b.i=a;try{b.b.onUpdateParams(a)}catch(c){}postMessage({rep:"params",instance:b.a})}\n',
        ...
        'function xa(a,b){var c=b.Symbol,d=b.MDEntryType,e=b.MDEntryPositionNo-1,g=b.MDEntryPx,h=b.MDEntrySize;null==a.c[c]&&(a.c[c]={bids:[],asks:[]});"0"==d?L(a.c[c].bids,[g,h],e):"1"==d&&L(a.c[c].asks,[g,h],e);if(a.d)try{a.b.onOrderBookNewOrder(b)}catch(l){}}\n',
        ...
        'f.A=function(a){a=JSON.parse(a.data);var b=a.MsgType;delete a.MsgType;switch(b){case "f":if(this.d)try{this.b.onTicker(a)}catch(c){}this.l||postMessage({rep:"create",instance:this.a,status:"received_security_status"});this.l=!0;break;case "W":for(var d in a.MDFullGrp){var e=a.MDFullGrp[d];e.MDReqID=a.MDReqID;switch(e.MDEntryType){case "0":case "1":e.Symbol=a.Symbol;xa(this,e);break;case "2":ya(this,e)}}this.k||postMessage({rep:"create",instance:this.a,status:"received_full_refresh"});this.k=!0;try{if(this.d)this.b.onOrderBookChange(this.c[symbol])}catch(g){}break;\n',
        'case "X":d=!1;for(e in a.MDIncGrp)switch(b=a.MDIncGrp[e],b.MDReqID=a.MDReqID,b.MDEntryType){case "0":case "1":d=!0;switch(b.MDUpdateAction){case "0":xa(this,b);break;case "1":var h=b.Symbol,l=b.MDEntryType,m=b.MDEntryPositionNo-1,y=b.MDEntrySize;"0"==l?this.c[h].bids[m]=[this.c[h].bids[m][0],y]:"1"==l&&(this.c[h].asks[m]=[this.c[h].asks[m][0],y]);if(this.d)try{this.b.onOrderBookUpdateOrder(b)}catch(za){}break;case "2":h=b.Symbol;l=b.MDEntryPositionNo-1;m=b.MDEntryType;"0"==m?this.c[h].bids.splice(l,\n',
        '1):"1"==m&&this.c[h].asks.splice(l,1);if(this.d)try{this.b.onOrderBookDeleteOrder(b)}catch(Aa){}break;case "3":if(h=b.Symbol,l=b.MDEntryPositionNo,m=b.MDEntryType,"0"==m?this.c[h].bids.splice(0,l):"1"==m&&this.c[h].asks.splice(0,l),this.d)try{this.b.onOrderBookDeleteOrdersThru(b)}catch(Ba){}}break;case "2":ya(this,b)}try{if(this.d&&d)this.b.onOrderBookChange(this.c[symbol])}catch(Ca){}}};var Z;\n',
        'addEventListener("message",function(a){try{var b=a.data;switch(b.req){case "create":var c=eval(context.algo_definition.creator);Z=new D(context.algo_instance_id,context.wss_url,context.symbol,context.open_orders,0,context.balance,c);break;case "start":sa(b.params);break;case "params":va(b.params);break;case "execution_report":wa(b.execution_report);break;case "stop":Z.stop();self.close();break;case "balance":ua(b.balances)}}catch(d){null!=Z&&ta(Z,d.message),self.close()}},!1);B("goog.bind",x);\n',
        'B("goog.isDefAndNotNull",function(a){return null!=a});B("goog.typeOf",p);B("goog.isDef",n);B("goog.isNull",function(a){return null===a});B("goog.isArray",q);B("goog.isArrayLike",r);B("goog.isDateLike",function(a){return u(a)&&"function"==typeof a.getFullYear});B("goog.isString",t);B("goog.isBoolean",function(a){return"boolean"==typeof a});B("goog.isNumber",function(a){return"number"==typeof a});B("goog.isFunction",function(a){return"function"==p(a)});B("goog.isObject",u);B("goog.cloneObject",w);\n',
        'B("goog.partial",z);B("goog.mixin",function(a,b){for(var c in b)a[c]=b[c]});B("goog.now",da);\n',
        'B("goog.globalEval",function(a){if(k.execScript)k.execScript(a,"JavaScript");else if(k.eval)if(null==A&&(k.eval("var _et_ = 1;"),"undefined"!=typeof k._et_?(delete k._et_,A=!0):A=!1),A)k.eval(a);else{var b=k.document,c=b.createElement("script");c.type="text/javascript";c.defer=!1;c.appendChild(b.createTextNode(a));b.body.appendChild(c);b.body.removeChild(c)}else throw Error("goog.globalEval not available");});\n',
        'B("goog.inherits",function(a,b){function c(){}c.prototype=b.prototype;a.h=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.I=function(a,c,g){for(var h=Array(arguments.length-2),l=2;l<arguments.length;l++)h[l-2]=arguments[l];return b.prototype[c].apply(a,h)}});\n',
        'B("goog.base",function(a,b,c){var d=arguments.callee.caller;if(!d)throw Error("arguments.caller not defined.  goog.base() cannot be used with strict mode code. See http://www.ecma-international.org/ecma-262/5.1/#sec-C");if(d.h){for(var e=Array(arguments.length-1),g=1;g<arguments.length;g++)e[g-1]=arguments[g];return d.h.constructor.apply(a,e)}e=Array(arguments.length-2);for(g=2;g<arguments.length;g++)e[g-2]=arguments[g];for(var g=!1,h=a.constructor;h;h=h.h&&h.h.constructor)if(h.prototype[b]===d)g=\n',
        '!0;else if(g)return h.prototype[b].apply(a,e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");});B("goog.array.splice",M);B("goog.array.insertAt",L);B("goog.array.indexOf",F);B("goog.array.lastIndexOf",ea);B("goog.array.forEach",G);B("goog.array.forEachRight",H);B("goog.array.filter",fa);B("goog.array.map",ga);B("goog.array.reduce",ha);B("goog.array.reduceRight",ia);B("goog.array.some",ja);\n',
        'B("goog.array.every",ka);B("goog.array.count",function(a,b,c){var d=0;G(a,function(a,g,h){b.call(c,a,g,h)&&++d},c);return d});B("goog.array.findIndex",I);B("goog.array.findRight",function(a,b,c){b=J(a,b,c);return 0>b?null:t(a)?a.charAt(b):a[b]});B("goog.array.findIndexRight",J);B("goog.array.contains",K);B("goog.array.isEmpty",function(a){return 0==a.length});B("goog.array.clear",function(a){if(!q(a))for(var b=a.length-1;0<=b;b--)delete a[b];a.length=0});\n',
        'B("goog.array.insert",function(a,b){K(a,b)||a.push(b)});B("goog.array.insertArrayAt",function(a,b,c){z(M,a,c,0).apply(null,b)});B("goog.array.insertBefore",function(a,b,c){var d;2==arguments.length||0>(d=F(a,c))?a.push(b):L(a,b,d)});B("goog.array.remove",function(a,b){var c=F(a,b),d;(d=0<=c)&&N(a,c);return d});B("goog.array.removeAt",N);B("goog.array.removeIf",function(a,b,c){b=I(a,b,c);return 0<=b?(N(a,b),!0):!1});B("goog.array.concat",function(a){return E.concat.apply(E,arguments)});\n',
        ...
        'B("goog.array.removeDuplicates",function(a,b,c){b=b||a;c=c||function(){return u(h)?"o"+(h[v]||(h[v]=++aa)):(typeof h).charAt(0)+h};for(var d={},e=0,g=0;g<a.length;){var h=a[g++],l=c(h);Object.prototype.hasOwnProperty.call(d,l)||(d[l]=!0,b[e++]=h)}b.length=e});B("goog.array.binarySearch",Q);B("goog.array.binarySelect",function(a,b,c){return R(a,b,!0,void 0,c)});B("goog.array.sort",T);\n',
        ...
        'B("goog.array.binaryRemove",function(a,b,c){b=Q(a,b,c);return 0<=b?N(a,b):!1});B("goog.array.bucket",function(a,b,c){for(var d={},e=0;e<a.length;e++){var g=a[e],h=b.call(c,g,e,a);n(h)&&(d[h]||(d[h]=[])).push(g)}return d});B("goog.array.toObject",function(a,b,c){var d={};G(a,function(e,g){d[b.call(c,e,g,a)]=e});return d});B("goog.array.range",function(a,b,c){var d=[],e=0,g=a;c=c||1;void 0!==b&&(e=a,g=b);if(0>c*(g-e))return[];if(0<c)for(a=e;a<g;a+=c)d.push(a);else for(a=e;a>g;a+=c)d.push(a);return d});\n',
        'B("goog.array.repeat",function(a,b){for(var c=[],d=0;d<b;d++)c[d]=a;return c});B("goog.array.flatten",V);B("goog.array.rotate",function(a,b){a.length&&(b%=a.length,0<b?E.unshift.apply(a,a.splice(-b,b)):0>b&&E.push.apply(a,a.splice(0,-b)));return a});B("goog.array.zip",function(a){if(!arguments.length)return[];for(var b=[],c=0;;c++){for(var d=[],e=0;e<arguments.length;e++){var g=arguments[e];if(c>=g.length)return b;d.push(g[c])}b.push(d)}});\n',
        'B("goog.array.shuffle",function(a,b){for(var c=b||Math.random,d=a.length-1;0<d;d--){var e=Math.floor(c()*(d+1)),g=a[d];a[d]=a[e];a[e]=g}});B("goog.object.forEach",W);B("goog.object.extend",pa);B("goog.object.filter",function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d});B("goog.object.map",function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d});B("goog.object.some",function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1});\n',
        'B("goog.object.every",function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0});B("goog.object.getCount",function(a){var b=0,c;for(c in a)b++;return b});B("goog.object.getAnyKey",function(a){for(var b in a)return b});B("goog.object.getAnyValue",function(a){for(var b in a)return a[b]});B("goog.object.contains",function(a,b){return ma(a,b)});B("goog.object.getValues",function(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b});\n',
        'B("goog.object.getKeys",function(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b});B("goog.object.getValueByKeys",function(a,b){for(var c=r(b),d=c?b:arguments,c=c?0:1;c<d.length&&(a=a[d[c]],n(a));c++);return a});B("goog.object.containsKey",function(a,b){return b in a});B("goog.object.containsValue",ma);B("goog.object.findKey",X);B("goog.object.findValue",function(a,b,c){return(b=X(a,b,c))&&a[b]});B("goog.object.isEmpty",function(a){for(var b in a)return!1;return!0});B("goog.object.clear",function(a){for(var b in a)delete a[b]});\n',
        'B("goog.object.remove",Y);B("goog.object.add",function(a,b,c){if(b in a)throw Error(\'The object already contains the key "\'+b+\'"\');a[b]=c});B("goog.object.get",function(a,b,c){return b in a?a[b]:c});B("goog.object.set",function(a,b,c){a[b]=c});B("goog.object.setIfUndefined",function(a,b,c){return b in a?a[b]:a[b]=c});B("goog.object.clone",function(a){var b={},c;for(c in a)b[c]=a[c];return b});B("goog.object.unsafeClone",na);B("goog.object.transpose",function(a){var b={},c;for(c in a)b[a[c]]=c;return b});\n',
        'B("goog.object.create",qa);B("goog.object.createSet",ra);B("goog.object.createImmutableView",function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b});B("goog.object.isImmutableView",function(a){return!!Object.isFrozen&&Object.isFrozen(a)});B("Application",D);C("sendBuyLimitedOrder",D.prototype.C);C("sendSellLimitedOrder",D.prototype.D);C("cancelAllOrders",D.prototype.n);C("cancelOrder",D.prototype.o);C("getOrderBook",D.prototype.t);C("getTrades",D.prototype.v);\n',
        'C("getBalance",D.prototype.p);C("getParameters",D.prototype.u);C("getOpenOrders",D.prototype.s);C("getMarket",D.prototype.r);C("getInstanceID",D.prototype.q);C("showNotification",D.prototype.G);C("stop",D.prototype.stop);\n'
      ];
